...
@pytest.mark.parametrize('x', [[[1, 2, 3, 4]], [[0.11, 0.2, 0.3, 0.4]], [[0.11, 1, 0.3, 0.4]]])
@pytest.mark.parametrize('y', [[[1, 2, 3, 4]], [[1, 2, 3, 4]]], [[0.11, 0.2, 0.3, 0.4]])
...
@pytest.mark.parametrize('x', [[[1, 2, 3]], [[0.11, 0.2, 0.3, 0.4]], [[]]])
@pytest.mark.parametrize('y', [[[1, 2, 3, 4]], [[1, 2, 3]]], [[0.11, 0.2, 0.3, 0.4]])
